      ...
      <div className="container m-8 mx-auto max-w-5xl">
        ...
        <div className="flex w-full flex-col flex-wrap sm:flex-row">
          <div className="w-full content-center p-6 sm:w-1/2">
            <h3 className="mb-3 text-3xl leading-none font-bold text-gray-800 dark:text-stone-100">{t('1.title')}</h3>
            <p className="mb-8 text-gray-600 dark:text-stone-200">{t('1.description')}</p>
          </div>
          <div className="relative mt-6 hidden w-full flex-1 p-6 sm:block sm:h-96 sm:w-1/3">
            <Image title={t('1.imageTitle')} src="/images/save-in-confort.svg" className="object-contain" fill alt="" />
          </div>
        </div>
        ...
        <div className="flex w-full flex-col-reverse flex-wrap sm:flex-row">
          ...
          <div className="mt-6 w-full content-center p-6 sm:w-1/2">
            <div className="align-middle">
              <h3 className="mb-3 text-3xl leading-none font-bold text-gray-800 dark:text-stone-100">{t('2.title')}</h3>
              <p className="mb-8 text-gray-600 dark:text-stone-200">{t('2.description')}</p>
            </div>
          </div>
        </div>
      </div>
